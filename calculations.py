...
def calculate(qdpm_data, operator_data):
    ...
    # result_numbers_file.to_excel('~/Desktop/result_numbers_file.xlsx')
    result_numbers_file.to_excel('result_numbers_file.xlsx')
    result_time_file = pandas.DataFrame(result_time)
    # result_time_file.to_excel('~/Desktop/result_time_file.xlsx')
